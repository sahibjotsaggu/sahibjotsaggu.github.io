# Generated by BootMap on 5/19/2015, 4:26:36 PM
...
Additionally, once you have connected your app to a gitbut repo, you can use `grunt deploy` and it will automagically take the current master branch and deploy it to `gh-pages`, which makes it publicly accessible at [http://sahibjotsaggu.github.io/website](http://sahibjotsaggu.github.io/website). Hotness!
...
## Contributing to `website` - uuh...  you need to fill this out eh :)
